...
On these four nodes you can set your own wait time, up to **5 minutes (300 seconds)**, by adding a `wait_time` parameter (in seconds) to the `Function Body`:
...
Read more in [Setting a custom wait time for AI webhook nodes](https://glific.github.io/docs/docs/Integrations/Setting%20a%20custom%20wait%20time%20for%20AI%20webhook%20nodes/).
