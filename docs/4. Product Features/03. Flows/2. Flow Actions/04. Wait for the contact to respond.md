...
- **Other branch**: an automatic branch that is always added alongside your criteria rows, for replies that don't match any of them. See "The no-response branch in your flow" below for what it looks like next to the No Response branch on the canvas.
