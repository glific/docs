...
- Please note: To receive voice-note outputs, your Glific instance must be linked to Google Cloud Storage for your organization. This stores voice notes generated by the `text_to_speech` webhook.  
