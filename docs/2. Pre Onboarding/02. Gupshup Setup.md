...
- Scoll down to the same setting page and copy the API key and and keep it handy in a notepad, if the API key is not visible, click on create API key and the API key will be created instantly.
...
- Now click on Organization >> Go to Organization phone number >> Update the Chatbot number (can find it on Gupshup beside under app live status)
...
7. How to Find Your Gupshup Username ?

If you forget your Gupshup username, you can request it from the Gupshup support team by email. Here’s how:
...
**Tip:** Save your username once you receive it to avoid requesting it again.
