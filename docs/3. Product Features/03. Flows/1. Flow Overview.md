...
4.  **Edit** : - **Name & Keywords** : Assign any unique name and keyword to the flow.
...
5.  **Delete** : The delete option will completely remove/ erase that particular flow from the flow list
...
<img width="634" height="167" alt="image" src="https://github.com/user-attachments/assets/cfb2e248-dee7-481a-a5bd-8a3f5b0cd517" />

- Uncheck the is active check box.

- Click on SAVE button

<img width="656" height="500" alt="image" src="https://github.com/user-attachments/assets/ecf90a74-fe97-4484-8a31-7f1b6ceaacd4" />
