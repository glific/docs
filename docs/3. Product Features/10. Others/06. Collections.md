...
## Expression to Retrieve User's Collection List

**Question:** What expression can we use to retrieve the list of collections a user belongs to?

**Answer:** You can use `@contact.in_groups` to retrieve the list of collection IDs associated with a contact.
