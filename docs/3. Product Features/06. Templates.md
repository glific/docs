...
## [Send Interactive Messages using Google Sheets](https://glific.github.io/docs/docs/Product%20Features/Flows/Flow%20Actions/Link%20Google%20Sheets/#send-template-messages-using-google-sheets)

## Tags in Template Messages
You can make use of [Tags](**https://glific.github.io/docs/docs/Product%20Features/Others/Tags#tags-in-flows**) in template messages to categorize template messages for better searchability and tracking. Please look at the link above to understand how to create `Tags` and view them on Glific.
